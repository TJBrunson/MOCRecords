...
urlpatterns = [
    ...
    path('checkout_queue', views.CheckoutQueue, name='checkout_queue'),
    path('checkout_queue/<int:id>', views.checkoutForm, name='checkout_form'),
    path('checkup/checkout_submit', views.CheckoutSubmit, name="checkout_submit"),
]
